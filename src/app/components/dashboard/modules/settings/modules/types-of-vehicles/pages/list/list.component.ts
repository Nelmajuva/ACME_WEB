...
import { TypesOfVehiclesService } from '../../../../../../../../services';
    ...
    <div class="px-4 sm:px-6 lg:px-8 animate__animated animate__fadeIn w-full">
      <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
          <h1 class="text-xl font-semibold">Tipos de vehículos</h1>
          <p class="mt-2 text-base text-gray-700">
            Tipos de vehículos admitidos en la organización.
          </p>
        </div>
          ...
          >
            <table class="min-w-full divide-y divide-gray-300">
              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                @for (typeOfVehicle of getListOfTypesVehicles; track $index) {
                <tr class="divide-x divide-gray-200">
                  <td
                  ...
                  >
                    {{ typeOfVehicle.created_at | date : 'dd/MM/yyyy HH:mm' }}
                  </td>
                  <td
                  ...
                  >
                    ...
                    <button
                      type="button"
                      [routerLink]="'edit/' + typeOfVehicle.id"
                      class="rounded bg-white px-2 py-1 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                    >
                      Editar
                    </button>
        ...
        >
          ...
          >
                      ...
                      <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                          <input
                            ...
                            type="text"
                            name="id"
                            [value]="getTypeOfVehicleToShow.id"
                            [readOnly]="true"
                      ...
                      <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                          <input
                            ...
                            type="text"
                            name="name"
                            [value]="getTypeOfVehicleToShow.name"
                            [readOnly]="true"
                            class="block w-full rounded-md outline-none border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
                          />
                        </div>
                      ...
                      <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                          <input
                            ...
                            name="name"
                            [value]="
                              getTypeOfVehicleToShow.created_at
                      ...
                      <div class="sm:col-span-6">
                        ...
                        <div class="mt-2">
                          <input
                            ...
                            name="name"
                            [value]="
                              getTypeOfVehicleToShow.updated_at
                                | date : 'dd/MM/yyyy HH:mm'
                            "
                            [readOnly]="true"
                            class="block w-full rounded-md outline-none border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
            ...
            >
              <button
                type="button"
                (click)="setTypeOfVehicleToShow = null"
...
export class ListComponent implements OnInit {
  private listOfTypesVehicles: any[];
  private typeOfVehicleToShow: any | null;

  private readonly typesOfVehiclesService: TypesOfVehiclesService;

  constructor() {
    this.typeOfVehicleToShow = null;
    this.listOfTypesVehicles = [];

    this.typesOfVehiclesService = inject(TypesOfVehiclesService);
  }
   ...
   */
  public index = () => {
    this.typesOfVehiclesService.index().subscribe({
      next: (res) => {
        this.listOfTypesVehicles = res.message.data;
      },
      error: () => {
  ...
  /**
   * Set type of vehicle to show in modal.
   *
   * @param id - Number
   */
  public view = (id: number) => {
    this.typeOfVehicleToShow =
      this.listOfTypesVehicles.find(
        (typeOfVehicle) => typeOfVehicle.id === id
      ) ?? null;
  };

  public get getListOfTypesVehicles() {
    return this.listOfTypesVehicles;
  }

  public set setTypeOfVehicleToShow(value: any | null) {
    this.typeOfVehicleToShow = value;
  }

  public get getTypeOfVehicleToShow() {
    return this.typeOfVehicleToShow;
  }
}
